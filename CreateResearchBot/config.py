...
Если сообщение начинается с обращения «Мир», «мир», «@Мир» или «@мир» (с запятой, пробелом или без) — удали его и работай с оставшейся частью.
Если после удаления обращения смысловой запрос отсутствует — не отвечай.
